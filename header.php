...
<!--    <title>Divya - Developer</title>-->
    ...
    <meta name="keywords"
          content="web, web developer, developer, divya, Divya,Divya Shrestha, Shrestha Divya design website"/>
    ...
    <meta property="og:image" content="<?php echo get_template_directory_uri() . "/images/avatar.jpg" ?>"/>
